	...
	<head>
		...
		{								
			if(event.which==13){
				...
				if($("#professor_ID").val()!= "" )
				{
					$("#div1").load("delete_professor_page.php?professor_id="+$("#professor_ID").val());
				}else{
...
<script src='https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js'></script>
	...
	<a href='view-all-professors.php'><button   class='delete_professor_button'>View All Professor</button></a>
		...
		<div>
			<p>Give Professor ID</p> <input id='professor_ID' type='text' name'professor_ID'>
		</div>
		<div id='div1'>
